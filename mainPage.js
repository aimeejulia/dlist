...
function addToList(){
        var toDoList = $.parseJSON($.cookie("toDoList"))
        ...
        $.cookie("toDoList", JSON.stringify(toDoList));
    }
...
if(e.target.parentElement.classList.contains('delBtn')){
  if(confirm("Are you sure you want to delete this task?")){
    ...
    return console.log("the task was deleted");
  }
}
}
...
input.addEventListener("keyup", function(event) {
    ...
    if (event.keyCode === 13) {
        ...
        return console.log("the task was added");
    }
});
